...
public class MaskSensitiveDataFilter implements Filter {
    ...
    private static final Logger logger = LogManager.getLogger(MaskSensitiveDataFilter.class);
    ...
    public MaskSensitiveDataFilter(String id, Configuration config, Context context) {
        ...
        logger.info("id: {}, pattern: {}, sourceField: {}", id, pattern, sourceField);
    }
    ...
    public Collection<Event> filter(Collection<Event> events, FilterMatchListener matchListener) {
        for (Event event : events) {
            ...
            if (fieldData instanceof String) {
                event.setField(sourceField, SecurityUtil.maskSensitiveMultiple((String)fieldData, pattern));
